            ...
            <div className="container">
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '64px', alignItems: 'center' }}>
                  <div className="space-y-8" style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                     <h1 className="text-5xl font-bold text-secondary leading-tight" style={{ fontSize: '48px', fontWeight: 'bold', lineHeight: 1.2 }}>Câu Chuyện Của <span className="text-primary" style={{ color: 'var(--primary)' }}>Ds Lương</span></h1>
                     <p className="text-gray-600 text-lg leading-relaxed" style={{ fontSize: '18px', color: '#555', lineHeight: '1.8' }}>
                        Được thành lập từ năm 2020, Ds Lương khởi đầu từ niềm đam mê với những nguyên liệu làm đẹp thuần khiết nhất. Chúng tôi tin rằng mỗi người đều sở hữu một vẻ đẹp riêng biệt và nhiệm vụ của chúng tôi là giúp bạn tự tin tỏa sáng vẻ đẹp đó.
                     </p>
                     <p className="text-gray-600 text-lg leading-relaxed" style={{ fontSize: '18px', color: '#555', lineHeight: '1.8' }}>
                        Từ một cửa hàng nhỏ chuyên doanh các dòng serum thảo mộc, Ds Lương đã không ngừng phát triển để trở thành điểm đến tin cậy của hàng nghìn phụ nữ Việt Nam trên hành trình chăm sóc sắc đẹp toàn diện.
                     </p>
